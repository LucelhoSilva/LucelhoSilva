...
- 🧠 Back-End Developer with expertise in **Python**, process automation, and systems integration.
- 🔒 I build **scalable and efficient** solutions for digital businesses.
- 🧰 Founder of **Elys**: delivering landing pages, e-commerce, SaaS, and tailored automation for clients — **+14 closed contracts**.
- 💬 Community Leader of **Developers** with **3,000+ members**.
- 👨‍🏫 Leader and Instructor at **Favela Ware**, where I trained over **40 young developers**, achieving **70%+ employment rate**.
- 🎓 Computer Science student at UNA University.
- 📚 Enrolled in the Full Stack Java course by EBAC.
- 🏛️ Currently working as **Technical Advisor for Development and Technology** at **Prefeitura de Pedro Leopoldo**.

<br><br>

<!-- Skills -->
<h2 align="left"> Languages & Tools <img src="https://em-content.zobj.net/source/microsoft-teams/337/man-technologist_1f468-200d-1f4bb.png" width="40px"> </h2>
...
<code><img width="40px" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/jira/jira-original-wordmark.svg" title="Jira"/></code>
<code><img width="40px" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nginx/nginx-original.svg" title="Nginx"/></code>

<br><br>

<!-- Experience -->
<h2>Technical Experience <img src="https://em-content.zobj.net/source/microsoft-teams/337/hammer-and-wrench_1f6e0-fe0f.png" width="30px"></h2>

- 🔁 Back-End development using **Python, Django, SQL**.
- ⚙️ **Process automation** and **RPA**.
- 🌐 RESTful **API integration** and **Web Scraping**.
- 🧠 AI Projects: **IA Contábil**, **IA4DEVS**.
- 📌 **Agile project management** (Scrum/Kanban).
- 👥 Mentoring and technical training for new developers.
...
<a href="https://wa.me/553198478235">
